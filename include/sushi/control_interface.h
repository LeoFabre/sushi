...
public:
    ...
    virtual ControlResponse create_track(const std::string& name, int channels) = 0;
    virtual ControlResponse create_multibus_track(const std::string& name, int buses) = 0;
